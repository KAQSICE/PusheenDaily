package com.tranced.pusheendailykt.commons.experimental.service

import com.tranced.pusheendailykt.commons.experimental.network.CommonBody
...
interface AuthService {
    ...
    fun getToken(
        @Query("twtuname") twtuname: String,
        @Query("twtpasswd") twtpasswd: String
    ): Deferred<CommonBody<Token>>
